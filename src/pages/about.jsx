            ...
            <div className="relative flex flex-col justify-center items-center mt-40 px-4 w-full gap-y-10">
                ...
                <div className=" flex flex-col md:flex-row justify-between items-center gap-10  w-full max-w-6xl px-4 mt-[-120px]">
                    ...
                    <div className="h-[40rem] w-full flex items-center justify-center">
                        <PinContainer title="poke-me" href="https://drive.google.com/file/d/1ZGsnxAcTRptw61Ka5-F-EOKBnWqjLasc/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
